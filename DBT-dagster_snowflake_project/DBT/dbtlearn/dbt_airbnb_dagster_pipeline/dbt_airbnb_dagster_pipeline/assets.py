# code where paritioning logic is not involved - 
...
# Partitioning setup for fct_reviews
...
class CustomDagsterDbtTranslator(DagsterDbtTranslator):
    def get_metadata(
        ...
        default = default_metadata_from_dbt_resource_props(dbt_resource_props)
